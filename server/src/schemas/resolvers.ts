...
const resolvers = {
  Query: {
    ...
    me: async (_parent: unknown, { _id }: Interfaces.UserArgs, context: Interfaces.Context) => {
      if (context.user) {
  ...
  Mutation: {
    login: async (_parent: unknown, { input }: Interfaces.loginArgs) => {
    ...
    addClient: async (_parent: unknown, { input }: Interfaces.AddClientArgs, context: Interfaces.Context) => {
      if (context.user) {
    ...
    updateClient: async (_parent: unknown, { input }: Interfaces.AddClientArgs, context: Interfaces.Context) => {
      if (context.user) {
        return await User.findOneAndUpdate(
    ...
    addHour: async (_parent: unknown, { input }: Interfaces.AddHourArgs, context: Interfaces.Context) => {
      if (context.user) {
        return await User.findOneAndUpdate(
    ...
    removeClient: async (_parent: unknown, { input }: Interfaces.DeleteArgs, context: Interfaces.Context) => {
      if (context.user) {
        return await User.findOneAndUpdate(
          { _id: input.user_id },
    ...
    removeHour: async (_parent: unknown, { input }: Interfaces.DeleteArgs, context: Interfaces.Context) => {
      if (context.user) {
        return await User.findOneAndUpdate(
          { _id: input.user_id, clients: { $elemMatch: { _id: input.client_id } } },
    ...
    removeAllHours: async (_parent: unknown, { input }: Interfaces.DeleteArgs, context: Interfaces.Context) => {
      if (context.user) {
        return await User.findOneAndUpdate(
          { _id: input.user_id, clients: { $elemMatch: { _id: input.client_id } } },
